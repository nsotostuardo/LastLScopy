...
def parse_args():
    ...
    parser.add_argument('-SpectralSigmas', type=str, default='', required=False, help = 'Comma-separated list of spectral sigmas to use instead of 0..MaxSigmas-1. Example: 0,1,2,4,8,16 [Default: empty]')
