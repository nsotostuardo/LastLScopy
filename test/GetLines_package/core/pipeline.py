...
from ..core.functions import get_binning, LS_final_candidates, spectral_sigma_count
...
class RealSources(ABC): #### Agrgar el espacial...
    ...
    def get_final_candidates(self, pp_BMAJ, FactorLEE, to_csv= True):
        n_spectral_trials = spectral_sigma_count(self.args)
        ...
        if self.args.UseFactorLEE:
            ...
            aux1 = 1.0 - (1.0 - aux1)**(n_spectral_trials)
            aux2 = 1.0 - (1.0 - aux2)**(n_spectral_trials)
            FinalpSimExp = 1.0 - (1.0 -  candidates["fpSimExp"])**(n_spectral_trials)
            ...
            aux1 = 1.0 - (1.0 - aux1)**(n_spectral_trials)
            aux2 = 1.0 - (1.0 - aux2)**(n_spectral_trials)
            FinalpPoiExp = 1.0 - (1.0 - candidates["fpPoiExp"])**(n_spectral_trials)
