...
from ..core.functions import GetMinSNEstimate, save_positives, save_negatives, open_cube, pixels_BMAJ, spectral_sigma_values
...
def main(args):
    ...
    sigma_values = spectral_sigma_values(args)
